<section>
    <header class="mb-4">
        <h2 class="fs-5 fw-medium text-dark text-bg-dark">
            ...
            @if ($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail())
                <div class="mt-2 text-muted">
                    <p class="text-sm">
                        ...
                        <button form="send-verification" class="underline text-sm text-secondary hover:text-dark rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800">
