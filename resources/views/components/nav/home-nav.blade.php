...
<div class="collapse navbar-collapse " id="navbarSupportedContent">
    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
            <a class="nav-link {{ Route::currentRouteName() == 'features' ? 'active' : '' }}" aria-current="page" href="{{route('features')}}">Features</a>
        </li>
        <li class="nav-item">
            <a class="nav-link {{ Route::currentRouteName() == 'aboutAs' ? 'active' : '' }}" aria-current="page" href="{{route('aboutAs')}}">About Us</a>
        </li>

        <li class="nav-item">
            <a class="nav-link {{ Route::currentRouteName() == 'pricing' ? 'active' : '' }}" aria-current="page" href="{{route('pricing')}}">Pricing</a>
        </li>
        <li class="nav-item">
