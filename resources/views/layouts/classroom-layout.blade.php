...
<head>
    ...
    <style>
        ...
        .slot{
            ...
            border-top: 1px solid rgb(5, 65, 65);
            border-left: 1px solid rgb(5, 65, 65);
        }
...
<div class="main-bg-color">
    ...
    <section class="row main-section">
        ...
        <nav class="min-vh-100 main-bg-color col-md-1 ">
            df
        </nav>

        <main class="min-vh-120 col-md-11 slot bg-white p-5">
            {{$slot}}
